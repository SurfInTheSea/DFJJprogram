...
def indexText(request):
	return render(request, 'DFJJ/index-self.html', context={
		"loginState":"F",
		"index":0,
		"code":"000",
		"productInfoVo":
...
def newguide(request):
	return render(request, 'DFJJ/newguide.html')

def trust(request):
	return render(request, 'DFJJ/trust.html')

def infomation(request):
	return render(request, 'DFJJ/infomation.html')
...
def maintz(request):
    ...
    return render(request, 'DFJJ/maintz.html', {'program_infos': program_infos})
...
def programDetails(request,pk):
    ...
    #print(pk)
    print(programDetail)
    return render(request, 'DFJJ/programDetails.html', {'programDetail':programDetail})
...
def buyProgramDetails(request, pk):
    ...
    return render(request, 'DFJJ/buyProgramDetails.html',{'programDetail':programDetail,'personalInfo':personalInfo})
...
def userCenter(request):
    ...
    moneyNow = user.money
    print(moneyTotall)
    return render(request, 'DFJJ/userCenter.html',{'payToday':round(payToday,2),'moneyTotall':moneyTotall,'moneyNow':moneyNow})
...
def banckAndaccount(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'DFJJ/userCenter/banckAndaccount.html')
...
def personalProgramDetails(request):
    ...
    for personalProgramDetail in personalProgramDetails:
        ...
        print(  personalProgramDetail.name,
    ...
    return render(request, 'DFJJ/userCenter/personalProgramDetails.html',{'personalProgramDetails':personalProgramDetails})
