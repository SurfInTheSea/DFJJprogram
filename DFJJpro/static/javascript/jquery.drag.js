...
(function($) {
	$.fn.drag = function(options) {
		...
		if(typeof ops.dragMarginBottom == "string"){
			ops.dragTop = parseFloat(ops.dragTop)*parseFloat($("html").css('fontSize'))
		}
		if(typeof ops.dragLeft == "string"){
			ops.dragLeft = parseFloat(ops.dragLeft)*parseFloat($("html").css('fontSize'))
		}
		if(typeof ops.dragMarginTop == "string"){
			ops.dragMarginTop = parseFloat(ops.dragMarginTop)*parseFloat($("html").css('fontSize'))
		}
		if(typeof ops.dragMarginBottom == "string"){
			ops.dragMarginBottom = parseFloat(ops.dragMarginBottom)*parseFloat($("html").css('fontSize'))
		}
